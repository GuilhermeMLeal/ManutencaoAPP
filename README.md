...
### 1. **Executar o Backend e o Frontend Web**

Na **root** do projeto, execute o comando abaixo para construir e iniciar todos os serviços (frontend e backend):
...
- Subir os contêineres que rodam o backend e o frontend web.
...
Ao rodar o comando `npm start`, o Expo abrirá o Metro Bundler no navegador. Para testar o aplicativo no celular:
- Instale o app **Expo Go** no dispositivo móvel.
- Use o QR Code gerado pelo Metro Bundler para abrir o aplicativo no celular.